...
class _AuthClient implements AuthClient {
  ...
  @override
  Future<ApiResponse<dynamic>> login(dynamic request) async {
  ...
  @override
  Future<ApiResponse<dynamic>> register(dynamic request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
...
String _$authClientHash() => r'760bdd852e37e7793846bdfb5a0bc97cced553c3';
